<template><div><h1 id="编程的几个基本概念" tabindex="-1"><a class="header-anchor" href="#编程的几个基本概念" aria-hidden="true">#</a> 编程的几个基本概念</h1>
...
<p>编程语言是用来控制计算机的一系列指令（Instruction），它有固定的格式和词汇（不同编程语言的格式和词汇不一样），必须遵守，否则就会出错，达不到我们的目的。</p>
...
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">// 这是一段 C 语言的示例源代码，作用是打印 Hello World</span>
